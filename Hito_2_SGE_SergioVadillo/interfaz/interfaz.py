...
def iniciar_interfaz():
    ...
    def mostrar_grafico(tipo_grafico):
        ...
        if tipo_grafico == "Consumo Promedio por Edad":
            ...
            plt.ylabel("")  # Ocultar la etiqueta en el eje Y para un gráfico de pastel
    ...
    # Función para actualizar encuesta seleccionada
    def modificar_encuesta():
        ...
        id_encuesta = int(valores[0])

        # Actualizar campos de entrada con los valores seleccionados
        entries[0].delete(0, tk.END)
        entries[0].insert(0, valores[1])
        entries[1].set(valores[2])
        entries[2].delete(0, tk.END)
        entries[2].insert(0, valores[3])
        entries[3].delete(0, tk.END)
        entries[3].insert(0, valores[4])
        entries[4].delete(0, tk.END)
        entries[4].insert(0, valores[5])
        entries[5].delete(0, tk.END)
        entries[5].insert(0, valores[6])
        entries[6].delete(0, tk.END)
        entries[6].insert(0, valores[7])
        entries[7].delete(0, tk.END)
        entries[7].insert(0, valores[8])
        entries[8].set(valores[9])
        entries[9].set(valores[10])
        entries[10].set(valores[11])
        entries[11].set(valores[12])

        # Función interna para guardar cambios
        def guardar_cambios():
        ...
        boton_guardar = tk.Button(frame_botones, text="Guardar Cambios", command=guardar_cambios)
    ...
    tk.Button(frame_botones, text="Actualizar", command=modificar_encuesta).pack(side="left", padx=5)
